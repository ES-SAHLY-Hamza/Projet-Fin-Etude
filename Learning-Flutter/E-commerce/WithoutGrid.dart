...
class _HomeState extends State<Home> {
  ...
  int selectedIndex = 0;
  List<Widget> liste = [
    Text("Bonjour Hamza" , style: TextStyle(fontSize: 20 , color: Colors.red)),
    Text("Bonjour Issam" , style: TextStyle(fontSize: 20 , color: Colors.green),)
  ];
                ...
                Expanded(child: TextFormField(
                  decoration: InputDecoration(
                      ...
                      prefixIcon: Container(
                        ...
                        child: Icon(Icons.search , size: 33.0),
                      )
                  ),
                )
                ),
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.person_2 , color: Colors.black54 , size: 40),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 3),
                          child: Text("Woman" , style: TextStyle(color: Colors.black54)),
                        )
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.play_lesson_outlined , color: Colors.black54 , size: 40),
                        ),
                        Container(
                    ...
                    InkWell(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(top: 10,right: 28),
