  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => FloatAction() ));
        },
      ...
      body: Container(
        child: isLoading == true ? Center(child: CircularProgressIndicator(color: Colors.blue),) :  GridView.builder(
