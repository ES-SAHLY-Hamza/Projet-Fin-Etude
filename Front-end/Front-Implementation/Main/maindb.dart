  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: (FirebaseAuth.instance.currentUser != null
          && FirebaseAuth.instance.currentUser!.emailVerified) ? HomeBottomSheets() : HomePageUI(),
      routes: {
        "/register" : (context) => RegisterStripe(),
        "/login" : (context) =>  LoginStripe(),
        "/homepage" : (context) => HomeBottomSheets(),
        "/profile" : (context) => ProfilePage(),
        "/HomeUI" : (context) => HomePageUI(),
        "/Annonce" : (context) => PublicationPage(),
      },
    );
  }
