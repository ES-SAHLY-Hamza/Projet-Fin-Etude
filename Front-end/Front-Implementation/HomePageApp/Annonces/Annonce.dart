...
class _MyApp extends State<PublicationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading ? Center(child: CircularProgressIndicator(color: Colors.blue)) : Padding(
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    Container(margin : EdgeInsets.only(left: 5) , child: IconButton(onPressed: _pickImage, icon: Icon(Icons.camera_alt))),
