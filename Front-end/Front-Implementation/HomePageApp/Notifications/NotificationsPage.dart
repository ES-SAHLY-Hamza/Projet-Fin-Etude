                ...
                child: ListView(
                  children: [
                    ...
                    StreamBuilder<List<Map<String, dynamic>>>(
                      stream: user != null ? getPersonsNotifications(user!.uid) : Stream.empty(),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          return Container(child: Center(child: CircularProgressIndicator(color: Colors.blue)));
                        } else if (snapshot.hasError) {
                          return Center(child: Text('Erreur: ${snapshot.error}'));
                        } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
                          return StreamBuilder<List<Map<String, dynamic>>>(
                            stream:  user != null ? getPersonsNotificationsComments(user!.uid) : Stream.empty(),
                                    ...
                                    children: [
                                      ...
                                      Stack(
                                        children: [
                                          Container(
                                            ...
                                            child: InkWell(
                                              child: imageProfile.startsWith('http')
                                                ...
                                                child: imageProfile.isEmpty ? Icon(Icons.person) : null,
                                              ),
                                              onTap: () {
                                          ...
                                          Container(
                                            margin: EdgeInsets.only(left: 90,top: 8,right: 50),
                                            child: RichText(
                                              text: TextSpan(
                                                children: [
                                                  TextSpan(
                                              ...
                                              Container(
                                                child: Stack(
                                                  children: [
                                                    ...
                                                    Container(child: Text(timeAgo,style: TextStyle(fontSize: 10),),margin: EdgeInsets.only(top: 25),)
                                                  ],
                                                ),
                                                margin: EdgeInsets.only(left: 90,top: 7 , right: 10),
                                              ),
                                            ],
                                          ...
                                          Container(
                                            ...
                                            margin: EdgeInsets.only(left: 90, top: 27,right: 80),
                                          ),
                                          Container(
                                            ...
                                            margin: EdgeInsets.only(left: 75, top: 35),
                                          ),
                                        ],
                                      )
                                          : Stack(
                                        children: [
                                          ...
                                          Container(
                                            margin: EdgeInsets.only(left: 90,top: 5,right: 58),
                                            child: RichText(
                                              text: TextSpan(
                                                children: [
                                                  TextSpan(
                                          ...
                                          Container(
                                            ...
                                            margin: EdgeInsets.only(left: 73, top: 30),
                                          ),
                                        ],
                                      ),
                                    ],
                                      ...
                                      Stack(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            margin: EdgeInsets.only(left: 185, top: 27,right: 65),
                                          ),
                                          Container(
                                            child: MaterialButton(
                                              onPressed: () {
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            margin: EdgeInsets.only(left: 90,top: 5,right: 80),
                                            child: RichText(
                                              text: TextSpan(
                                                children: [
                                                  TextSpan(
                                          ...
                                          Container(
                                            ...
                                            margin: EdgeInsets.only(left: 135 , top: 43,right: 70),
                                          ),
                                          Row(
                                            children: [
                                              Container(
                                          ...
                                          Container(
                                            ...
                                            margin: EdgeInsets.only(left: 73, top: 48),
                                          ),
                                        ],
                                      ),
                                    ],
