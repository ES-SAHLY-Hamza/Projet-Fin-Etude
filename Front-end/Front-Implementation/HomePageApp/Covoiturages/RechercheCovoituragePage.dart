                        ...
                        children: [
                          ...
                          ontap
                            ...
                            children: [
                              Container(
                                margin: EdgeInsets.only(left: 60, top: 22),
                                child: Text('Sélectionner votre position', style: TextStyle(fontWeight: FontWeight.w600)),
                              ),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(right: 20, top: 22),
                                    child: Text('Selected', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.green)),
                                  ),
                                ],
                              )
                            ],
