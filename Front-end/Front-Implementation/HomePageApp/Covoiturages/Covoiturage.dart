...
class _CovoituragePageState extends State<CovoituragePage> {
  ...
  CameraPosition cameraPosition = CameraPosition(target: LatLng(34.01789928905642, -5.0072285905480385) , zoom: 13.5);
                ...
                child: Stack(
                  children: [
                      InkWell(
                        ...
                        child: Container(margin : EdgeInsets.only(top: 5, left: 8) , child: Image.asset('assets/covoiturage2.png')),
                      ),
                    StreamBuilder<List<Map<String, dynamic>>>(
                      stream: user != null ? getNotificationsCount(user!.uid) : Stream.empty(),
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 83, top: 18),
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => RechercheCovoituragePage()),
                          );
                        },
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          margin: EdgeInsets.only(top: 16.5 , right: 20),
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => AddCovoiturage()));
                            },
