  ...
  Future<void> showCovoiturageDetails(String userId, String covoiturageId,String userDiscussion,String image , String name) async {
    ...
    if (covoiturageDoc.exists) {
              ...
              children: [
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      child: FlipImage(imagePath: 'assets/Biker2.png',size: 100),
                    ),
                    Container(
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 175, top: 35),
                      child: Text(
                        'Départ localisation :',
                        style: TextStyle(
                          color: Colors.white,
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 175, top: 50),
                      child: Text(
                        data['quartier'],
                        style: TextStyle(
                          color: Colors.green,
                    ...
                    Stack(
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(top: 120 , left: 72),
                          child: Text(data['prenom'] , style: TextStyle(
                            color: Colors.white,
                          )),
                        )
                      ],
                    ...
                    Stack(
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(top: 145 , left: 40),
                          child: Text(data['prix'], style: TextStyle(
                              color: Colors.white,
                              fontSize: 13
                          )),
                        )
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          child: Text('Nombre de places : ' , style: TextStyle(
                              color: Colors.grey
                          )),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 170 , left: 140),
                          child: Text('${data['places']}', style: TextStyle(
                            color: Colors.white,
                          )),
                        )
                      ],
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          child: Text("L'horaire : " , style: TextStyle(
                              color: Colors.grey
                          )),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 195 , left: 75),
                ...
                Stack(
                  children: [
                    Container(
                      margin: EdgeInsets.only(left: 20),
                      child: FlipImage(imagePath: 'assets/voitureRouge.png'),
                    ),
                    Container(
                      margin: EdgeInsets.only(left: 210,top: 5),
                      child: Icon(Icons.location_on,color: Colors.white),
                ...
                children: [
                  Container(
                    ...
                    child: MaterialButton(
                      ...
                      child: Text('Fermer',style: TextStyle(fontWeight: FontWeight.w600),),
                      onPressed: () {
                  ...
                  Container(
                    child: MaterialButton(
                      ...
                      child: Text('Contacter',style: TextStyle(fontWeight: FontWeight.w600),),
                      onPressed: () async{
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Covoiturage non trouvé')),
      );
    }
  }
                        ...
                        children: [
                          Expanded(
                            child: StreamBuilder<List<Map<String, dynamic>>>(
                              stream: user != null ? getAllCovoituragesForCurrentUser() : Stream.empty(),
                              builder: (context, snapshot) {
                                if (snapshot.connectionState == ConnectionState.waiting) {
                                  return Center(child: Text('Chargement pour les demandes...'));
                                }else if (snapshot.hasError) {
                                  return Center(child: Text('Erreur : ${snapshot.error}'));
                                } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
                                  return Center(child: Text("Aucun demande de covoiturage disponible !"));
                                } else {
                                                  ...
                                                  Stack(
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Icon(Icons.help,color: Colors.white,size: 13,),
                                                        decoration: BoxDecoration(
                                                            border: Border(
                                                      ...
                                                      Container(
                                                        ...
                                                        margin: EdgeInsets.only(left: 30, top: 65),
                                                      ),
                                                    ],
                                                  ),
                                                  Expanded(
                                                    child: Stack(
                                                      children: [
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child: Container(
                                                                ...
                                                                margin: EdgeInsets.only(top: 30, right: 30 , left: 12),
                                                              ),
                                                            ),
                                                          ],
                                                        ),
                                                        Container(
                                                          ...
                                                          margin: EdgeInsets.only(left: 12, top: 48),
                                                        ),
                                                      ],
                                                    ),
                                                  ),
          ...
          AnimatedPositioned(
            ...
            child: AnimatedOpacity(
              ...
              child: Container(
                ...
                child: Center(child: Text("Détails du covoiturage")),
              ),
            ),
          ),
        ],
