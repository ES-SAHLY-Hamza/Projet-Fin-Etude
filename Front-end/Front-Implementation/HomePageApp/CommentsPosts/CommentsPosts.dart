...
class CommentsPosts extends StatefulWidget{
  ...
  const CommentsPosts({Key? key, required this.annonceId, required this.userId,}) : super(key: key);
  @override
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Stack(
                                                children: [
                                                  likesCount == 0 ? Container(margin: EdgeInsets.only(left: 30),) :
                                                  Stack(
                                                    children: [
                                                      Container(
                                                          margin: EdgeInsets.only(top: 3),
                                                          child: Icon(Icons.thumb_up, color: Colors.blue,size: 15,)),
                                                      InkWell(
                                                        child: Container(
                                            ...
                                            Container(
                                              child: Stack(
                                                children: [
                                                  ...
                                                  InkWell(
                                                    child: Container(
                                                      margin: EdgeInsets.only(left: 80, top: 2),
                                                      child: Text(
                                                        ...
                                                        Stack(
                                                          children: [
                                                            ...
                                                            Container(
                                                              ...
                                                              margin: EdgeInsets.only(left: 67, right: 20), // Ajustez la marge si nécessaire
                                                              ...
                                                              child: Stack(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    margin: EdgeInsets.only(left: 8, top: 55,bottom: 15),
                                                                    child: Text(
                                                                      commentaire,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8), // Correction de la taille de l'espace horizontal
                  Container(
