...
class DiscussionPage extends StatefulWidget {
  ...
  const DiscussionPage({Key? key, required this.NomComplet, required this.ProfileImage, required this.UserId, }) : super(key: key);
          ...
          Expanded(
            child: Stack(
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(left: 110,top: 9),
                ...
                Container(
                  margin: EdgeInsets.only(left: 110,top: 31),
                  child: Text("Usager Fes-Shore",style: TextStyle(
                    fontFamily: "assets/Roboto-Regular.ttf",
                    fontSize: 12,
                          ...
                          Container(
                            ...
                            child: InkWell(
                              child: widget.ProfileImage != '' && widget.ProfileImage.startsWith('http')
                                ...
                                radius: 24,
                                backgroundImage: FileImage(File(widget.ProfileImage)),
                                child: widget.ProfileImage.isEmpty ? Icon(Icons.person) : null,
                              )
                                  : Icon(Icons.person),
                            ),
                          ),
