                                            ...
                                            Stack(
                                              children: [
                                                ...
                                                Container(
                                                    ...
                                                    child: Icon(Icons.chat_bubble,color: Colors.white,size: 13,),
                                                    decoration: BoxDecoration(
                                                    border: Border(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          margin: EdgeInsets.only(top: 31, right: 30),
                                                        ),
                                                      ),
                                                    ],
                                                  )
                                                            ...
                                                            child: StreamBuilder<int>(
                                                              ...
                                                              builder: (context, snapshot) {
                                                                if (snapshot.connectionState == ConnectionState.waiting) {
                                                                  ...
                                                                  return Center(child: Text('Aucun message non lu'));
                                                                } else {
                                                                  ...
                                                                  return Stack(
                                                                    children: [
                                                                      unreadMessageCount > 0 ? Stack(
                                                                        children: [
                                                                          Container(
                                                                            margin: EdgeInsets.only(left: 12,top: 33),
                                                                            decoration: BoxDecoration(
                                                                              color: Colors.red,
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            margin: EdgeInsets.only(left: 35, top: 30,right: 30),
                                                                          ),
                                                                        ],
                                                                      )
                                                                        : Container(
                                                                        ...
                                                                        margin: EdgeInsets.only(left: 13, top: 30,right: 30),
                                                                      ),
                                                                    ],
                                                                  );
                                                                }
