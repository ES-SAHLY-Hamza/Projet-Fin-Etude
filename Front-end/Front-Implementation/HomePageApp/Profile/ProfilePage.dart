              ...
              children: [
                  ...
                  child: Column(
                    ...
                    : Column(
                      children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Container(
                                  margin: EdgeInsets.only(left: 17),
                                  child: Text( userData!['Titre'] ,style: TextStyle(
                                      fontFamily: "assets/Roboto-Regular.ttf",
                                      fontWeight: FontWeight.w500,
                                      fontSize: 14
                                  ),),
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Container(
                                  margin: EdgeInsets.only(left: 17),
                                  child: Text("Lieu d'entreprise : " + userData!['Lieu'] , style: TextStyle(
                                    fontSize: 13,
                                    fontFamily: "assets/Roboto-Regular.ttf",
                                    fontWeight: FontWeight.w500,
                                  ),),
                        ...
                        const SizedBox(height: 20),
                        userData == null || userData!['SecondEntreprise'] == null ? PlusExperience()
                            : Column(
                          children: [
                            Container(
                              child: Column(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Container(
                                            margin: EdgeInsets.only(left: 17),
                                            child: Text( userData!['SecondTitre'] ,style: TextStyle(
                                                fontFamily: "assets/Roboto-Regular.ttf",
                                                fontWeight: FontWeight.w500,
                                                fontSize: 14
                                            ),),
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Container(
                                            margin: EdgeInsets.only(left: 17),
                                            child: Text("Lieu d'entreprise : " + userData!['SecondLieu'] , style: TextStyle(
                                              fontSize: 13,
                                              fontFamily: "assets/Roboto-Regular.ttf",
                                              fontWeight: FontWeight.w500,
                                            ),),
                ...
                Column(
                  children: [
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text( userData!['Diplome'] ,style: TextStyle(
                                        fontFamily: "assets/Roboto-Regular.ttf",
                                        fontWeight: FontWeight.w500,
                                        fontSize: 14
                                    ),),
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    margin: EdgeInsets.only(left: 17),
                                    child: Text( "Domaine : " + userData!['Domaine'] ,style: TextStyle(
                                        fontFamily: "assets/Roboto-Regular.ttf",
                                        fontWeight: FontWeight.w500,
                                        fontSize: 13
                                    ),),
                    ...
                    const SizedBox(height: 20),
                    userData == null || userData!['SecondUniversite'] == null ? PlusFormation()
                        : Column(
                      children: [
                        Container(
                          child: Column(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        margin: EdgeInsets.only(left: 17 , top : 5),
                                        child: Text( userData!['SecondDiplome'] ,style: TextStyle(
                                            fontFamily: "assets/Roboto-Regular.ttf",
                                            fontWeight: FontWeight.w500,
                                            fontSize: 14
                                        ),),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        margin: EdgeInsets.only(left: 17),
                                        child: Text( "Domaine : " + userData!['SecondDomaine'] ,style: TextStyle(
                                            fontFamily: "assets/Roboto-Regular.ttf",
                                            fontWeight: FontWeight.w500,
                                            fontSize: 13
                                        ),),
                        ...
                        const SizedBox(height: 20),
                        userData == null || userData!['ThirdUniversite'] == null ? PlusFormationV2() :
                         Column(
                           children: [
                             Container(
                               child: Column(
                                     ...
                                     Row(
                                       ...
                                       children: [
                                         Expanded(
                                           child: Container(
                                             margin: EdgeInsets.only(left: 17 , top : 5),
                                             child: Text( userData!['ThirdDiplome'] ,style: TextStyle(
                                                 fontFamily: "assets/Roboto-Regular.ttf",
                                                 fontWeight: FontWeight.w500,
                                                 fontSize: 14
                                             ),),
                                     ...
                                     Row(
                                       ...
                                       children: [
                                         Expanded(
                                           child: Container(
                                             margin: EdgeInsets.only(left: 17),
                                             child: Text( "Domaine : " + userData!['ThirdDomaine'] ,style: TextStyle(
                                                 fontFamily: "assets/Roboto-Regular.ttf",
                                                 fontWeight: FontWeight.w500,
                                                 fontSize: 13
                                             ),),
